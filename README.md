...
Methods whose core mechanism is designed exclusively for diffusion-generated images (relies on diffusion model inversion or diffusion-specific artifacts; would not apply to GAN-generated images).
