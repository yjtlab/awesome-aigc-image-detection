...
+ [**Unmasking AI-Created Visual Content: A Review of Generated Images and Deepfake Detection Technologies**](https://arxiv.org/abs/2502.xxxxx) | 2025
+ [**Deep Industrial Image Anomaly Detection: A Survey**](https://link.springer.com/article/10.1007/s11633-023-1459-z) | Machine Intelligence Research 2024
+ [**A Survey on AI-Generated Image Detection: Techniques, Datasets, and Future Directions**](https://arxiv.org/abs/2401.xxxxx) | 2024
...
| [**Learning on Gradients: Generalized Artifacts Representation for GAN-Generated Images Detection**](https://arxiv.org/abs/2304.xxxxx) | CVPR | 2023 | [GitHub](https://github.com/chuangchuangtan/LGrad) | Gradient |
...
| [**Diffusion Noise Feature: Accurate and Fast Generated Image Detection**](https://arxiv.org/abs/2312.02625) | ICLR | 2024 | [GitHub](https://github.com/YichiCS/DNF) | Diffusion |
| [**DRCT: Diffusion Reconstruction Contrastive Training towards Universal Detection**](https://openreview.net/pdf?id=oRLwyayrh1) | ICML | 2024 | [Dataset](https://modelscope.cn/datasets/BokingChen/DRCT-2M/files) | Reconstruction |
| [**Exposing the Fake: Effective Diffusion-Generated Images Detection**](https://arxiv.org/abs/2307.06272) | ICML | 2024 | - | Reconstruction |
...
+ [**Consistency Verification for Detecting AI-Generated Images (ConV)**](https://openreview.net/forum?id=PSQuy9sjQ8) | - | [Code](https://github.com/tmlr-group/ConV) | `Zero-shot`
+ [**Unveiling Perceptual Artifacts: A Fine-Grained Benchmark for Interpretable AI-Generated Image Detection (X-AIGD)**](https://arxiv.org/abs/xxxx) | Xiao et al. | [Code](https://github.com/Coxy7/X-AIGD) | `Benchmark`

### AAAI 2026

+ [**Detecting AI-Generated Images via Distributional Deviations from Real Images (MPFT)**](https://arxiv.org/abs/xxxx) | Niu et al. | `Perturbation`
+ [**Color Matters: Demosaicing-Guided Color Correlation Training for Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhong et al. | `Color / Fingerprint`
+ [**Your AI-Generated Image Detector Can Secretly Achieve SOTA Accuracy, If Calibrated**](https://arxiv.org/abs/xxxx) | Yang et al. | `Calibration`
...
+ [**ForgeLens: Data-Efficient Forgery Focus for Generalizable Forgery Image Detection**](https://arxiv.org/abs/xxxx) | Chen et al. | [Code](https://github.com/Yingjian-Chen/ForgeLens) | `CLIP`
+ [**LOTA: Bit-Planes Guided AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Wang et al. | `Frequency`
+ [**Forensic-MoE: Exploring Comprehensive Synthetic Image Detection Traces with Mixture of Experts**](https://arxiv.org/abs/xxxx) | Fang et al. | `Ensemble`
+ [**Semantic Discrepancy-aware Detector for Image Forgery Identification**](https://arxiv.org/abs/xxxx) | Wang et al. | `Semantic`
+ [**D³QE: Learning Discrete Distribution Discrepancy-aware Quantization Error for Autoregressive-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhang et al. | `Autoregressive`
+ [**Bridging the Gap Between Ideal and Real-world Evaluation: Benchmarking AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Li et al. | `Benchmark`
+ [**Diffusion Epistemic Uncertainty with Asymmetric Learning for Diffusion-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Huang et al. | `Diffusion`
+ [**Beyond Semantic Features: Pixel-level Mapping for Generalized AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhou et al. | `Pixel-level`
...
+ [**Towards Universal AI-Generated Image Detection by Variational Information Bottleneck Network**](https://arxiv.org/abs/xxxx) | Zhang et al. | [Code](https://github.com/oceanzhf/VIBAIGCDetect) | `CLIP`
...
+ [**Secret Lies in Color: Enhancing AI-Generated Images Detection with Color Distribution Analysis**](https://arxiv.org/abs/xxxx) | Jia et al. | `Color`
...
+ [**FakeShield: Explainable Image Forgery Detection and Localization via Multi-modal Large Language Models**](https://arxiv.org/abs/xxxx) | Xu et al. | [Code](https://github.com/zhipeixu/FakeShield) | `LMM`
...
+ [**Denoising Trajectory Biases for Zero-Shot AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Liang et al. | `Zero-shot`
+ [**Training-free Detection of AI-generated images via Cropping Robustness (WaRPAD)**](https://arxiv.org/abs/xxxx) | Choi et al. | `Training-free`
+ [**Towards Generalizable Detector for Generated Image (DEnD)**](https://arxiv.org/abs/xxxx) | Cai et al. | [Code](https://github.com/dav-joy-thon/DEnD-Detection) | `Perturbation`
+ [**Epistemic Uncertainty for Generated Image Detection (WePe)**](https://arxiv.org/abs/xxxx) | Nie et al. | [Code](https://github.com/tmlr-group/WePe) | `Uncertainty`

### ECCV 2024

+ [**Zero-Shot Detection of AI-Generated Images**](https://arxiv.org/abs/xxxx) | Cozzolino et al. | `Zero-shot`
+ [**Contrasting Deepfakes Diffusion via Contrastive Learning and Global-Local Similarities**](https://arxiv.org/abs/xxxx) | Baraldi et al. | `Contrastive`
+ [**Leveraging Representations from Intermediate Encoder-Blocks for Synthetic Image Detection**](https://arxiv.org/abs/xxxx) | - | `Feature`
+ [**Forgery-aware Adaptive Transformer for Generalizable Synthetic Image Detection**](https://arxiv.org/abs/xxxx) | - | `Transformer`
...
+ [**Exposing the Fake: Effective Diffusion-Generated Images Detection**](https://arxiv.org/abs/2307.06272) | Ma et al. | `Reconstruction`
...
+ [**DRCT: Diffusion Reconstruction Contrastive Training towards Universal Detection**](https://openreview.net/pdf?id=oRLwyayrh1) | Chen et al. | `Reconstruction`
...
+ [**Detecting Generated Images by Real Images**](https://link.springer.com/content/pdf/10.1007/978-3-031-19781-9.pdf) | Tang et al. | [Code](https://github.com/Tangsenghenshou/Detecting-Generated-Images-by-Real-Images) | `Real-Only`
+ [**FingerprintNet: Synthesized Fingerprints for Generated Image Detection**](https://arxiv.org/abs/xxxx) | - | `Fingerprint`
+ [**On The Detection of Synthetic Images Generated by Diffusion Models**](https://arxiv.org/abs/xxxx) | Corvi et al. | [Code](https://github.com/grip-unina/DMimageDetection) | `Diffusion`

</details>

<details>
<summary>CVPR 2022</summary>
...
+ [**Watch your Up-Convolution: CNN Based Generative Deep Neural Networks are Failing to Reproduce Spectral Distributions**](https://arxiv.org/abs/xxxx) | Durall et al. | `Frequency`
+ [**Fourier Spectrum Discrepancies in Deep Network Generated Images**](https://arxiv.org/abs/xxxx) | - | [Code](https://github.com/tarikdzanic/FourierSpectrumDiscrepancies) | `Frequency`
...
+ [**PatchCraft: Exploring Texture Patch for Efficient AI-generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhong et al. 2024 | `Patch`
...
+ [**DeeCLIP: A Robust and Generalizable Transformer-Based Framework**](https://arxiv.org/abs/xxxx) | 2025 | `CLIP`
+ [**DGS-Net: Distillation-Guided Gradient Surgery for CLIP Fine-Tuning in AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Yan et al. 2025 | `CLIP`
+ [**NS-Net: Decoupling CLIP Semantic Information through NULL-Space for Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Yan et al. 2025 | `CLIP`
+ [**When Semantics Regulate: Rethinking Patch Shuffle for AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | 2025 | `CLIP`
...
+ [**PLOT: Prompt Learning with Optimal Transport**](https://arxiv.org/abs/xxxx) | `Prompt`
+ [**Image-Adaptive Prompt Learning for AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | 2025 | `Prompt`

#### 1.3 Feature Decoupling & Fusion

+ [**CausalCLIP: Causally-Informed Feature Disentanglement and Filtering for Generalizable Detection**](https://arxiv.org/abs/xxxx) | Liu et al. 2025 | `CLIP`
+ [**MiraGe: Multimodal Discriminative Representation Learning for Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Shi et al. 2025 | `CLIP`
...
+ [**Towards Universal AI-Generated Image Detection by Variational Information Bottleneck Network**](https://arxiv.org/abs/xxxx) | Zhang et al. | CVPR 2025 | [Code](https://github.com/oceanzhf/VIBAIGCDetect) | `CLIP`
+ [**Multimodal Conditional Information Bottleneck for Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Qin et al. 2025 | `CLIP`
...
+ [**STD-FD: Spatio-Temporal Distribution Fitting Deviation for AIGC Forgery Identification**](https://arxiv.org/abs/xxxx) | Lou et al. | `Reconstruction`
...
+ [**CINEMAE: Leveraging Frozen Masked Autoencoders for Cross-Generator AI Image Detection**](https://arxiv.org/abs/xxxx) | Jang et al. 2025 | `Reconstruction`
...
+ [**FakeInversion: Learning to Detect Images from Unseen Text-to-Image Models by Inverting Stable Diffusion**](https://arxiv.org/abs/xxxx) | Cazenavette et al. | CVPR 2024 | `Reconstruction`
...
+ [**GLARE: Towards Generalizable Detection of Latent Diffusion Images with Global-Local Reconstruction Error**](https://arxiv.org/abs/xxxx) | 2025 | `Reconstruction`
+ [**Exposing the Fake: Effective Diffusion-Generated Images Detection**](https://arxiv.org/abs/2307.06272) | Ma et al. | ICML 2024 | `Reconstruction`

#### 2.5 Pixel-level Decomposition

+ [**PiD: Generalized AI-Generated Images Detection with Pixelwise Decomposition Residuals**](https://arxiv.org/abs/xxxx) | Fu et al. | `Reconstruction`
+ [**Beyond Semantic Features: Pixel-level Mapping for Generalized AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhou et al. 2025 | `Pixel-level`
+ [**MLEP: Multi-granularity Local Entropy Patterns for Generalized AI-generated Image Detection**](https://arxiv.org/abs/xxxx) | Yuan et al. | `Pattern`

---

### 3. Frequency-domain Methods

+ [**Generalizable AI-Generated Image Detection Based on Fractal Self-Similarity in the Spectrum**](https://arxiv.org/abs/xxxx) | Xiao et al. 2025 | `Frequency`
...
+ [**LOTA: Bit-Planes Guided AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Wang et al. 2025 | `Frequency`
+ [**Improving Synthetic Image Detection Towards Generalization: An Image Transformation Perspective**](https://arxiv.org/abs/xxxx) | Li et al. 2025 | `Frequency`
+ [**Training-Free AI-Generated Image Detection via Spectral Artifacts**](https://arxiv.org/abs/xxxx) | `Frequency`
+ [**Secret Lies in Color: Enhancing AI-Generated Images Detection with Color Distribution Analysis**](https://arxiv.org/abs/xxxx) | Jia et al. | CVPR 2025 | `Color`
+ [**Color Matters: Demosaicing-Guided Color Correlation Training for Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhong et al. 2026 | `Color`
+ [**Fourier Spectrum Discrepancies in Deep Network Generated Images**](https://arxiv.org/abs/xxxx) | NeurIPS 2020 | [Code](https://github.com/tarikdzanic/FourierSpectrumDiscrepancies) | `Frequency`
...
+ [**PatchCraft: Exploring Texture Patch for Efficient AI-generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhong et al. 2024 | `Patch`
+ [**All Patches Matter, More Patches Better: Enhance AI-Generated Image Detection via Panoptic Patch Learning**](https://arxiv.org/abs/xxxx) | Yang et al. 2025 | `Patch`
+ [**TextureCrop: Enhancing Synthetic Image Detection through Texture-based Cropping**](https://arxiv.org/abs/xxxx) | Konstantinidou et al. | `Texture`
+ [**Breaking Semantic Artifacts for Generalized AI-generated Image Detection**](https://arxiv.org/abs/xxxx) | Zheng et al. | `Texture`
+ [**FerretNet: Efficient Synthetic Image Detection via Local Pixel Dependencies**](https://arxiv.org/abs/xxxx) | Liang et al. 2025 | `Pixel`
+ [**No Pixel Left Behind: A Detail-Preserving Architecture for Robust High-Resolution AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Mu et al. 2025 | `Pixel`
+ [**Rethinking the Use of Vision Transformers for AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Park et al. 2025 | `Architecture`

---

### 5. Noise / Fingerprint-based Methods

+ [**Revealing the Implicit Noise-based Imprint of Generative Models**](https://arxiv.org/abs/xxxx) | Li et al. 2025 | `Noise`
+ [**Using Wavelet Domain Fingerprints to Improve Source Camera Identification**](https://arxiv.org/abs/xxxx) | Tian et al. 2025 | `Fingerprint`
+ [**Perceptual Classifiers: Detecting Generative Images using Perceptual Features**](https://arxiv.org/abs/xxxx) | Durbha et al. 2025 | `Perceptual`
+ [**Zhong - Beyond Generation: A Diffusion-based Low-level Feature Extractor for Detecting AI-generated Images**](https://arxiv.org/abs/xxxx) | Zhong et al. | `Feature`
+ [**HFI: A Unified Framework for Training-free Detection and Implicit Watermarking of Latent Diffusion Models**](https://arxiv.org/abs/xxxx) | Choi et al. 2024 | `Fingerprint`
...
+ [**Detecting AI-Generated Images via Distributional Deviations from Real Images**](https://arxiv.org/abs/xxxx) | Niu et al. 2026 | `Perturbation`
+ [**Epistemic Uncertainty for Generated Image Detection (WePe)**](https://arxiv.org/abs/xxxx) | Nie et al. | NeurIPS 2025 | [Code](https://github.com/tmlr-group/WePe) | `Uncertainty`
+ [**How Noise Benefits AI-generated Image Detection**](https://arxiv.org/abs/xxxx) | Yan et al. 2025 | `Noise`
+ [**Towards Generalizable Detector for Generated Image (DEnD)**](https://arxiv.org/abs/xxxx) | Cai et al. | NeurIPS 2025 | [Code](https://github.com/dav-joy-thon/DEnD-Detection) | `Perturbation`
+ [**Detecting Generated Images by Fitting Natural Image Distributions**](https://arxiv.org/abs/xxxx) | Zhang et al. | `Distribution`
...
+ [**ThinkFake: Reasoning in Multimodal Large Language Models for AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Huang et al. 2025 | `LMM`
+ [**FakeReasoning: Towards Generalizable Forgery Detection and Reasoning**](https://arxiv.org/abs/xxxx) | Gao et al. 2025 | `LMM`
+ [**Spot the Fake: Large Multimodal Model-Based Synthetic Image Detection with Artifact Explanation**](https://arxiv.org/abs/xxxx) | Wen et al. 2025 | `LMM`
+ [**Veritas: Generalizable Deepfake Detection via Pattern-Aware Reasoning**](https://arxiv.org/abs/xxxx) | Tan et al. 2025 | `LMM`
...
+ [**FakeShield: Explainable Image Forgery Detection and Localization via Multi-modal Large Language Models**](https://arxiv.org/abs/xxxx) | Xu et al. | ICLR 2025 | [Code](https://github.com/zhipeixu/FakeShield) | `LMM`
+ [**FAKEXPLAIN: AI-Generated Images Detection via Human-Aligned Grounded Reasoning**](https://arxiv.org/abs/xxxx) | `LMM`
+ [**Explainable Synthetic Image Detection through Diffusion Timestep Ensembling**](https://arxiv.org/abs/xxxx) | Wu et al. 2025 | `Explainable`
...
+ [**Intermediate Representations Are Strong Training-Free AI-Generated Image Detectors**](https://arxiv.org/abs/xxxx) | `Training-free`
+ [**Training-Free AI-Generated Image Detection via Spectral Artifacts**](https://arxiv.org/abs/xxxx) | `Training-free`
+ [**Forensic Self-Descriptions Are All You Need for Zero-Shot Detection, Open-Set Source Attribution, and Localization**](https://arxiv.org/abs/xxxx) | Nguyen et al. 2025 | `Zero-shot`
...
+ [**Zero-Shot Detection of AI-Generated Images**](https://arxiv.org/abs/xxxx) | Cozzolino et al. | ECCV 2024 | `Zero-shot`
+ [**Consistency Verification for Detecting AI-Generated Images (ConV)**](https://openreview.net/forum?id=PSQuy9sjQ8) | ICLR 2026 | [Code](https://github.com/tmlr-group/ConV) | `Zero-shot`
+ [**Triggering Generative Collapse: A Contrastive Inversion Framework for AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | arXiv | `Zero-shot`
+ [**General and Domain-Specific Zero-shot Detection of Generated Images via Conditional Likelihood**](https://arxiv.org/abs/xxxx) | Betser et al. 2025 | `Zero-shot`
+ [**Training-free Detection of AI-generated images via Cropping Robustness**](https://arxiv.org/abs/xxxx) | Choi et al. | `Training-free`
+ [**Denoising Trajectory Biases for Zero-Shot AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Liang et al. | `Zero-shot`
+ [**Revisiting Reconstruction-based AI-generated Image Detection: A Geometric Perspective**](https://arxiv.org/abs/xxxx) | Jiang et al. 2025 | `Zero-shot`
+ [**Understanding and Improving Training-Free AI-Generated Image Detections with Vision Foundation Models**](https://arxiv.org/abs/xxxx) | Tsai et al. 2024 | `Training-free`

---

### 9. Diffusion-specific Detection

+ [**On the Detection of Synthetic Images Generated by Diffusion Models**](https://arxiv.org/abs/xxxx) | Corvi et al. 2022 | [Code](https://github.com/grip-unina/DMimageDetection) | `Diffusion`
+ [**Diffusion Noise Feature: Accurate and Fast Generated Image Detection**](https://arxiv.org/abs/2312.02625) | Zhang et al. | [Code](https://github.com/YichiCS/DNF) | `Diffusion`
+ [**Diffusion Epistemic Uncertainty with Asymmetric Learning for Diffusion-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Huang et al. | ICCV 2025 | `Diffusion`
+ [**PRADA: Probability-Ratio-Based Attribution and Detection of Autoregressive-Generated Images**](https://arxiv.org/abs/xxxx) | Damm et al. 2025 | `AR / Diffusion`

---

### 10. Autoregressive Model Detection

+ [**PRADA: Probability-Ratio-Based Attribution and Detection of Autoregressive-Generated Images**](https://arxiv.org/abs/xxxx) | Damm et al. 2025 | `Autoregressive`
+ [**D³QE: Learning Discrete Distribution Discrepancy-aware Quantization Error for Autoregressive-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhang et al. 2025 | `Autoregressive`
...
+ [**Veritas: Generalizable Deepfake Detection via Pattern-Aware Reasoning**](https://arxiv.org/abs/xxxx) | Tan et al. 2025 | `LMM + Deepfake`
+ [**Real-Time Deepfake Detection in the Real-World**](https://arxiv.org/abs/xxxx) | Cavia et al. 2024 | `Deepfake`
...
+ [**Dual Data Alignment Makes AI-Generated Image Detector Easier Generalizable**](https://arxiv.org/abs/xxxx) | Chen et al. 2025 | `Generalization`
...
+ [**Task-Model Alignment: A Simple Path to Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Chen et al. 2025 | `Generalization`
...
+ [**Beyond Artifacts: Real-Centric Envelope Modeling for Reliable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Liu et al. 2025 | `Real-Centric`
+ [**Your AI-Generated Image Detector Can Secretly Achieve SOTA Accuracy, If Calibrated**](https://arxiv.org/abs/xxxx) | Yang et al. 2026 | `Calibration`
...
+ [**Scaling Up AI-Generated Image Detection via Generator-Aware Prototypes**](https://arxiv.org/abs/xxxx) | Qin et al. 2025 | `Multi-Generator`
+ [**Breaking Latent Prior Bias in Detectors for Generalizable AIGC Image Detection**](https://arxiv.org/abs/xxxx) | Zhou et al. 2025 | `Generalization`
+ [**Exploring the Collaborative Advantage of Low-level Information on Generalizable AI-Generated Image Detection**](https://arxiv.org/abs/xxxx) | Zhou et al. 2025 | `Generalization`
...
+ [**MIRAGE: Towards AI-Generated Image Detection in the Wild**](https://arxiv.org/abs/xxxx) | Xia et al. 2025 | `Wild`
+ [**ENABLING YOUR FORENSIC DETECTOR KNOW HOW WELL IT PERFORMS ON DISTORTED SAMPLES**](https://arxiv.org/abs/xxxx) | `Robustness`
...
+ [**AEDR: Training-Free AI-Generated Image Attribution via Autoencoder Double-Reconstruction**](https://arxiv.org/abs/xxxx) | Wang et al. 2025 | `Attribution`
+ [**Which Model Generated This Image? A Model-Agnostic Approach for Origin Attribution**](https://arxiv.org/abs/xxxx) | Liu et al. 2024 | `Attribution`
+ [**PRADA: Probability-Ratio-Based Attribution and Detection of Autoregressive-Generated Images**](https://arxiv.org/abs/xxxx) | Damm et al. 2025 | `Attribution`

---

### 14. Manipulation Localization

+ [**IML-ViT: Benchmarking Image Manipulation Localization by Vision Transformer**](https://arxiv.org/abs/xxxx) | Ma et al. 2024 | `Localization`
+ [**Zooming In on Fakes: A Novel Dataset for Localized AI-Generated Image Detection with Forgery Amplification**](https://arxiv.org/abs/xxxx) | Cai et al. 2025 | `Localization`
+ [**GenPTW: In-Generation Image Watermarking for Provenance Tracing and Tamper Localization**](https://arxiv.org/abs/xxxx) | Gan et al. 2025 | `Watermark`
+ [**OpenSDI: Spotting Diffusion-Generated Images in the Open World**](https://arxiv.org/abs/xxxx) | Wang et al. 2025 | `Detection + Localization`
...
| **OpenFake** | Open dataset and platform for large-scale deepfake detection | 2025 | [Paper](https://arxiv.org/abs/xxxx) |
...
| Dataset | Description | Year | Link |
|:--------|:-----------|:----:|:----:|
| **CTForensics** | AI-Generated CT image detection | 2026 | [Paper](https://arxiv.org/abs/xxxx) |
...
| **SIDBench** | Python framework for assessing synthetic image detection methods | 2024 | [Paper](https://arxiv.org/abs/xxxx) |
...
|:-----|:-----------|:----:|
| **ForensicHub** | Unified benchmark & codebase | [Paper](https://arxiv.org/abs/xxxx) |
| **SIDBench** | Python framework for SID assessment | [Paper](https://arxiv.org/abs/xxxx) |
...
@misc{awesome-aigc-image-detection,
  ...
  year={2025},
  publisher={GitHub},
  howpublished={\url{https://github.com/awesome-aigc-image-detection}}
}
```

---

**Last Updated**: 2026-03-14 | **Total Papers**: 160+
