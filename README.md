...
+ [**A Sanity Check for AI-generated Image Detection (AIDE)**](https://arxiv.org/abs/2406.19435) | - | [Code](https://github.com/shilinyan99/AIDE) | `Benchmark` `Feature Fusion`
...
Methods specifically designed for detecting diffusion model-generated images (targeting LDM artifacts, denoising traces, etc.).

#### 9.1 Reconstruction Error

+ [**DIRE for Diffusion-Generated Image Detection**](https://arxiv.org/abs/2303.09295) | Wang et al. | ICCV 2023 | [Code](https://github.com/ZhendongWang6/DIRE) | `Diffusion` `Reconstruction`
...
+ [**LATTE: Latent Trajectory Embedding for Diffusion-Generated Image Detection**](https://arxiv.org/abs/2507.03054) | Vasilcoiu et al. 2025 | [Code](https://github.com/AnaMVasilcoiu/LATTE-Diffusion-Detector) | `Diffusion`
+ [**GRRE: Leveraging G-Channel Removed Reconstruction Error for Robust Detection of AI-Generated Images**](https://arxiv.org/abs/2601.02709) | He et al. 2026 | `Diffusion`
...
+ [**SARE: Semantic-Aware Reconstruction Error for Generalizable Diffusion-Generated Image Detection**](https://arxiv.org/abs/2508.09487) | Kang et al. 2025 | `Diffusion`

#### 9.2 Frequency & Feature Analysis
...
+ [**Beyond Generation: A Diffusion-based Low-level Feature Extractor for Detecting AI-generated Images**](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhong_Beyond_Generation_A_Diffusion-based_Low-level_Feature_Extractor_for_Detecting_AI-generated_CVPR_2025_paper.pdf) | Zhong et al. | CVPR 2025 | `Diffusion`
+ [**Diffusion Noise Feature: Accurate and Fast Generated Image Detection**](https://arxiv.org/abs/2312.02625) | Zhang et al. | ECAI 2025 | [Code](https://github.com/YichiCS/DNF) | `Diffusion`

#### 9.3 Probabilistic / Trajectory Methods
...
+ [**Denoising Trajectory Biases for Zero-Shot AI-Generated Image Detection**](https://openreview.net/forum?id=2h8vXbEufN) | Liang et al. | NeurIPS 2025 | `Diffusion` `Training-free`
